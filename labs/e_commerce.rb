...
while response != 'n'
	...
	shoes = gets.chomp
		...
		if shoes == 'y'
			puts "How many pair?"
			num_of_shoes = gets.to_i

			puts "Your purchase : #{num_of_shoes} shoes for a total of #{shoe_total = shoe_price * num_of_shoes}"	
		
		# def shoe_total(shoe_price, num_of_shoes=0)
		# 	shoe_price * num_of_shoes		
		# end		
